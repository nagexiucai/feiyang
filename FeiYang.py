...
class FyFrame(wx.Frame):
    def __init__(self, title):
        ...
        FyMenuBarMixin(self)
        self.__panel = FyLayoutMixin(self)
        self.AuiLayout()
        FyStatusBarMixin(self)
        self.EvtBind()
    def AuiLayout(self):
        self.__wmanager = wx.aui.AuiManager(self.__panel)
        self.__fyexplorer = FyNotebookMixin(self.__panel)
        self.__fyinterpreter = FyNotebookMixin(self.__panel)
        self.__fymedia = FyNotebookMixin(self.__panel)
